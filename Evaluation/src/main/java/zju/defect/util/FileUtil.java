...
public class FileUtil {
	...
	public static String setFileName(String filePath, String commitHash){
//		return (commitHash.substring(0,4)+ "_"+filePath.substring(filePath.lastIndexOf("/")+1));
		return (commitHash.substring(0,4)+ "_"+filePath.substring(filePath.lastIndexOf("/",filePath.lastIndexOf("/")-1)+1).replace("/", "_"));

	}

	public static void main(String[] args){
		System.out.print(setFileName("activemq-unit-tests/src/test/java/org/apache/activemq/store/jdbc/JDBCIOExceptionHandlerTest.java", "2hjda2134fas"));
	}
}
