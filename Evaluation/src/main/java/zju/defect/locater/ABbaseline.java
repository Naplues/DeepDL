...
import slp.core.example.JavaRunner2;
...
//		"jenkins1710","robolectric1710", "flink1710", "jetty1710", "jitsi1710", "jmeter1710", "libgdx1710", "h2o1710"};
//	public static String[] projects = new String[] {"closure-compiler1710"};
	public static String[] projects = new String[] {"activemq1710", "closure-compiler1710", "deeplearning4j1710", "druid1710",
													"flink1710", "graylog2-server1710", "jenkins1710",
													"jetty1710", "jitsi1710", "jmeter1710", "libgdx1710",
													"robolectric1710", "storm1710", "h2o1710"};
...
//			   preProcess(modelType);
	...
	private static void modelBuilding(String modelType, String ngramType, int ngramLength) throws IOException {
		...
		for (int i = 0; i < projects.length; i++) {
			...
			String trainSetPathJava = root +  thisProject + "/" + modelType + "/" + thisProject + "_bpe_train4.java";
...
//			String testSetPathCSV = root + thisProject + "/" + thisProject + "_test.csv";
			...
			String testSetPathJava = root + thisProject + "/" + modelType + "/" + thisProject + "_bpe_test4.java";
			...
			String entropyTestResultCSV = root + thisProject + "/" + modelType + "/" + thisProject
					+ "_bpe_entropyTestResult.csv";
			JavaRunner2 jr = new JavaRunner2();
	...
	private static void modelEvaluation(String modelType, double trainRatio, String ngramType, int ngramLength)
		...
		String finalAllProjectsResults = root + "ngram_bpe4.csv";
...
//					+ "_eachTrueBugCommitResultLSTM.csv";
			...
			String entropyTestResult = root + thisProject + "/" + modelType + "/" + thisProject + "_bpe_entropyTestResult.csv";
...
//			String generateJitFeatures = root +  thisProject + "/"+ thisProject + ".csv";  // jit features
			...
			String trainSetPathJava = root + thisProject + "/" + modelType + "/" + thisProject + "_bpe_train3" + modelType
					+ ".java";
			String trainSetPathCSV = root + thisProject + "/" + modelType + "/" + thisProject + "_bpe_train" + modelType
					+ ".csv";			
...
//			String testSetPathCSV = root + thisProject + "/" + thisProject + "_test.csv";
//			String testSetPathJava = root + thisProject + "/" + thisProject + "_test.java";
			String testSetPathCSV = root + thisProject + "/" + modelType + "/" + thisProject + "_bpe_test.csv";
			String testSetPathJava = root + thisProject + "/" + modelType + "/" + thisProject + "_bpe_test3.java";
